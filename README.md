...
Ans: To add a new element firstly I use document.createElement('tagName') to create the tag in memory.Then I can add some text inside.innerText or add some styling using .classList.add().Finally,to show it on the website I attached it to an existing element using appendChild() or prepend().
